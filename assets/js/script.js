...
$(document).ready(() => {
	...
	$('.carousel-thumb').on('click', function(e) {
		...
		$('.carousel-photo-stage').css('background-image', 'url(http://134.209.23.223:4002/ob/images/'+hash+')');		
	})
	...
	$('#crypto-inventory').each(function(index) {
		...
		$.getJSON("http://134.209.23.223:4002/ob/inventory/"+peerID+"/" + slug + "?usecache=true", function(data) {
