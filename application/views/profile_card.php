<div class="Profile-Card">
	<a href="/store/<?=(isset($profile->peerID))?$profile->peerID:""?>"><div class="Profile-Card-Hero" style="background-image: url('<?=(isset($profile->headerHashes))?"http://134.209.23.223:4002/ob/images/".$profile->headerHashes->small."?usecache=true" : asset_url()."img/defaultHeader.png"?>');">
		<div class="Profile-Card-Avatar" style="background-image: url('<?=((isset($profile->avatarHashes)) && ($profile->avatarHashes->small!="")) ? "http://134.209.23.223:4002/ob/images/".$profile->avatarHashes->small."?usecache=true" : asset_url()."img/defaultAvatar.png"?>');" title="<?=(isset($profile->name))?$profile->name:"Unknown"?>" onclick="location.href='/store/<?=(isset($profile->peerID))?$profile->peerID:"";?>'"></div>
	</div></a>
