<div id="Store-Header-Mobile">
	...
	<div class="Store-Home-Mini-Header" style="background-image: url('<?php if($header_image) { ?>http://134.209.23.223:4002/ob/images/<?php echo (isset($profile->headerHashes)) ? $profile->headerHashes->tiny : ''; ?><?php } else { ?><?=asset_url()?>img/defaultHeader.png<?php } ?>');"></div>
	
	<div class="mobile-store-caption">
		
		<div class="mobile-avatar-title">
			<div class="Store-Home-Avatar">
				<img style="background-image: url('<?php echo (isset($profile->avatarHashes)) ? "http://134.209.23.223:4002/ob/images/".$profile->avatarHashes->tiny : asset_url().'img/defaultAvatar.png?>'; ?>');"/>
			</div>
