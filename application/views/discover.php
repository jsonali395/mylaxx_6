		...
		<div class="Discover-Body">	
			...
			?>				
				...
				<div class="Discover-Body-Listing-Box">
					...
					<div class="Discover-Body-Listing-Box-Photo" style="background-image: url('http://134.209.23.223:4002/ob/images/<?=$listing->data->thumbnail->small?>?usecache=true'), url('<?=asset_url()?>img/defaultItem.png');">
					...
					<div style="display: flex; margin-top: 10px;">						
						...
						<div class="Search-Avatar-Circle" style="background-image: url('<?php echo (($listing->relationships->vendor->data->avatarHashes->small!="")) ? "http://134.209.23.223:4002/ob/images/".$listing->relationships->vendor->data->avatarHashes->small."?usecache=true" : asset_url()."img/defaultAvatar.png"?>');" title="<?=$listing->relationships->vendor->data->name?>"></div>
						</a>
							</div>
				
					</div>
					
<!-- 					<div class="Search-Avatar-Circle" style="z-index:1000;float:right;margin-top:-21px;background-image: url('<?php echo (($listing->relationships->vendor->data->avatarHashes->small!="")) ? "http://134.209.23.223:4002/ob/images/".$listing->relationships->vendor->data->avatarHashes->small : asset_url()."img/defaultAvatar.png"?>');" title="<?=$listing->relationships->vendor->data->name?>" onclick="location.href='/store/<?=$listing->relationships->vendor->data->peerID?>'"></div> -->
