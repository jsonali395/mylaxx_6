...
<?php } ?>
<meta name="twitter:image" content="http://134.209.23.223:4002/ob/images/<?php echo (isset($listing->item->images)) ? $listing->item->images[0]->medium. "?usecache=true" : ''; ?>" />
...
<meta property="og:image" content="http://134.209.23.223:4002/ob/images/<?php echo (isset($listing->item->images)) ? $listing->item->images[0]->medium . "?usecache=true": ''; ?>">
<meta property="og:url" content="https://openbazaar.com/store/<?=$profile->peerID?>/<?=$listing->slug?>">
		...
		<div class="Rectangle-10 clearfix">
			...
			<div class="Listing-Breadcrumb button">
				<a href="/store/<?=$profile->peerID?>" title="<?=$profile->name?>"><div class="Store-Avatar-Circle" style="background-image: url('<?php echo (isset($profile->avatarHashes)) ? "http://134.209.23.223:4002/ob/images/".$profile->avatarHashes->tiny. "?usecache=true" : asset_url().'img/defaultAvatar.png?>'; ?>');"></div></a>
			...
			<div class="Listing-Box clearfix no-margins Main-Section">
				...
				<div id="Listing-Box-Mobile" class="clearfix">
					...
					<div id="buy-button-social-mobile" class="Buy-Button-Social">
						...
						<a href="http://pinterest.com/pin/create/button/?url=<?=base_url()?>store/<?=$listing->vendorID->peerID?>/<?=$listing->slug?>&media=http://134.209.23.223:4002/ob/images/<?php echo (isset($listing->item->images)) ? $listing->item->images[0]->medium . "?usecache=true": ''; ?>&description=<?=urlencode($listing->item->title)?>" target="_blank"><img src="<?=asset_url()?>img/icon-pinterest.png" height=12.5 target="_blank"/></a>
					</div>		
				</div>
			...
			<div class="Listing-Upper">
				<div style="width:100%;">
					<a href="#photos"><div id="Listing-Upper-Image" style="background-image: url('http://134.209.23.223:4002/ob/images/<?php echo (isset($listing->item->images)) ? $listing->item->images[0]->medium. "?usecache=true" : ''; ?>');"></div></a>
				...
				<div class="Purchase-Button-Col2">
						...
						<div id="listing-metadata-box">
							...
							<div style="width: inherit; display: flex;  align-items: center;">
								...
								<div class="Buy-Button-Social">
									...
									<a href="http://pinterest.com/pin/create/button/?url=<?=base_url()?>store/<?=$listing->vendorID->peerID?>/<?=$listing->slug?>&media=http://134.209.23.223:4002/ob/images/<?php echo (isset($listing->item->images)) ? $listing->item->images[0]->medium . "?usecache=true": ''; ?>&description=<?=urlencode($listing->item->title)?>" target="_blank"  title="Share on Pinterest"><img src="<?=asset_url()?>img/icon-pinterest.png" height=12.5 target="_blank"/></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="verified-mod-container">
						...
						<div style="font-size: 14px">You can purchase this listing with a moderator verified by <strong>OB1</strong>. <a href="http://134.209.23.223:4002/verified-moderators.html" target="_blank">Learn more</a></div>
					</div>
					<?php } ?>
