        ...
        <div style="flex:1">
		    <div style="display:flex;height:40px;">
                ...
                <div class="Store-Share">
                    ...
                    <a href="http://pinterest.com/pin/create/button/?url=<?=base_url()?>store/<?=$profile->peerID?>&media=http://134.209.23.223:4002/ob/images/<?php echo (isset($profile->headerHashes)) ? $profile->headerHashes->large. "?usecache=true" : ''; ?>&description=<?=urlencode($profile->shortDescription)?>" target="_blank"  title="Share on Pinterest"><img src="<?=asset_url()?>img/icon-pinterest.png" height=12.5 target="_blank"/></a>
                </div>
            ...
            <div class="listings-container">
                ...
                ?>
                    ...
                    <div rating="<?=$listing->averageRating?>" freeShipping="<?=implode($listing->freeShipping, ",")?>" category="<?=($listing->categories) ?implode(",", $listing->categories): "";?>" class="Store-Body-Listing-Box  <?php if($i%3==2) { echo "Discover-Body-Listing-Box-Last"; } ?>">
                        ...
                        <div class="Store-Body-Listing-Box-Photo lazy" data-src='http://134.209.23.223:4002/ob/images/<?=$listing->thumbnail->small. "?usecache=true"?>');" style="background-image: url('<?=asset_url()?>img/defaultItem.png');">
