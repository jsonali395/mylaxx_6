	...
	<div class="Page-Sub-Content clearfix Page-Sub-Content-Mobile Store-Content">
		...
		<div class="Store-Col1">
			<div class="Store-Filter-Box no-padding" style="width:306px;">
				...
				<div class="Store-Home-Mini-Header" style="background-image: url('<?php if($header_image) { ?>http://134.209.23.223:4002/ob/images/<?php echo (isset($profile->headerHashes)) ? $profile->headerHashes->tiny : ''; ?><?php } else { ?><?=asset_url()?>img/defaultHeader.png<?php } ?>');">
